		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<?php echo $form->open(); ?>
					...
					<?php echo $form->bs3_text('Meal Name', 'name', $meal->name); ?>
					<?php echo $form->bs3_text('Meal Ingredient', 'ingredient', $meal->ingredient); ?>

						<label for="facility_types">Meal Type</label>
						<div class="row">
							<div class="col-md-3">
								<?php echo $form->field_dropdown('type', $mealtype, $selected_type); ?>
							</div>
						</div>
						<br>
						...
						<div class="row">
							<div class="col-md-3">
								<?php echo $form->field_dropdown('timeserving', $mealtimeserving, $selected_timeserving); ?>
							</div>
						</div>
						<br>
